...
@Component({
  selector: 'app-suivi-interventions',
  templateUrl: './suivi-interventions.component.html',
  styleUrls: ['./suivi-interventions.component.scss']
})
export class SuiviInterventionsComponent implements OnInit {
